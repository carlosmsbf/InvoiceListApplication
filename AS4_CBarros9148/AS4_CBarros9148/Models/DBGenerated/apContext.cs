...
namespace AS4_CBarros9148.Models.DBGenerated
{
    public partial class apContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("name=VendorsDBContext");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GeneralLedgerAccount>(entity =>
            {
                entity.HasKey(e => e.AccountNumber)
                    .HasName("PK__general___AF91A6ACEDEA4777");
            ...
            modelBuilder.Entity<Term>(entity =>
            {
                entity.HasKey(e => e.TermsId)
                    .HasName("PK__terms__10DEB556674FD820");
